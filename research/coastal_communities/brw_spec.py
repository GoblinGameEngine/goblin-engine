...
RD = [
    ...
    ("BRW-096", [R + "97", R + "98"], "Speedway go-karts, Gillian's Wonderland Pier", "Ocean City, NJ", 2000, "go_karts", "A go-kart speedway on the pier: a figure-eight of smooth asphalt edged with a padded tyre barrier and a low fence, a timing hut and a start gantry lit with bulbs, a row of little open karts in the pits. The year is estimated."),
